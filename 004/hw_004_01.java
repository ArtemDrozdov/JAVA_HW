...
public class hw_004_01 {
    ...
    private static String dequeToString(Deque<String> deque) {
        ...
        for (int i = 0; i < deque.size(); i++) {
            ...
            /*
             * Соколов Никита・Преподаватель
            Добрый день, задание выполнено верно!
            Без строки 65 - программа в цикле обновляет каждый раз очередь, 
            но i уже увеличилась и например после удаления 5ого элемента i = 5 и к примеру Очередь стала = 5, 
            цикл завершается (но элементы в очереди ещё остались).
             */
        }
